...
{attribname: "eyesight", descs: ["You're rather short sighted. You'll need to wear glasses.","","You have perfect vision, you'll be able to see objects clearly from miles away.","Your eyesight is superhuman. You can see in the dark, and can detect lies better than any polygraph if you can see the speaker"]},
{attribname: "constitution", descs: ["","You're more hardy than normal, you get sick less often and recover faster.","You'll always have perfect health, age much slower, and are immune to all illnesses and diseases.","Your injuries great and small renegerate extremely quickly, leaving your skin forever pristine. Expect to age very slowly and gracefully, and to survive all but dedicated efforts to end you"]},
{attribname: "intelligence", descs: ["You're kind of scatterbrained at times. You get distracted easily and find it hard to focus for long.","","You're quick-witted, have a good memory, and often catch the little details others might miss","You're easily a genius, you have an eidetic memory, and you're capable of recognizing patterns and drawing deductions that no one else can.","You're easily a genius, with an eidetic memory, superhuman pattern recognition and deductive ability enhanced by your ability to maintain multiple parallel trains of thought and compute information superhumanly quickly."]},
...
{category: "CursedTransformation", effectname: "Age Regression", img:"none", desc: "<span style='color:yellow'><em>\"Time for a lesson you must hear, sometimes you must go back a year.\"</em></span><br/><br/><span style='float:right'>As the words form, you feel yourself getting younger, the years just slipping away from your body. Should you grow younger than 16, you feel puberty start to slip away too - your curves and height lessened, to return as you age</span><br/><br/><span style='color:lime'>(Age Regression!)</span>",requiresattribcustom:"age",randwt:1},
{category: "CursedTransformation", effectname: "Heat", img:"none", desc: "<span style='color:yellow'><em>\"Nature's eternal clock will make you crave a cock!\"</em></span><br/><br/><span style='float:right'>As the words form, a slight tingle runs over your body and you feel different.</span><br/><br/><span style='color:lime'>(Heat!)</span>",requiresattribnotmin:"gender",requiresattribnotmax:"heat"},
